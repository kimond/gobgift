...
urlpatterns = patterns('',
    ...
    url(r'^lists/$', 'gobgift.views.lists', name='lists'),
    url(r'^mylists/$', 'gobgift.views.mylists', name='mylists'),
    url(r'^lists/add/$', ListCreate.as_view(), name='addList'),
    url(r'^lists/view/(?P<pk>\d+)/$', 'gobgift.views.viewlist', name='viewListe'),
    url(r'^lists/edit/(?P<pk>\d+)/$', 'gobgift.views.editList', name='editListe'),
